...
const Cart = () => {
  ...
  const fetchCart = async () => {
    ...
    try {
      const response = await axios.get("https://code-with-her-backend-production.up.railway.app/api/cart/status", {
        headers: {
  ...
  const clearCart = async () => {
    ...
    try {
      const response = await axios.delete("https://code-with-her-backend-production.up.railway.app/api/cart/clear", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
