...
const ProductDetails = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await fetch(`https://code-with-her-backend-production.up.railway.app/api/products/${id}`);
  ...
  const addToCart = async () => {
    try {
      ...
      const response = await axios.post(
        "https://code-with-her-backend-production.up.railway.app/api/cart/add",
        {
