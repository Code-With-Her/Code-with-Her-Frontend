...
const Farmers = () => {
  ...
  if (loading) {
    return (
      <div
        className="flex justify-center items-center min-h-screen bg-[#FCFCFC]"
      >
    ...
    <div className="bg-[#FCFCFC] min-h-screen px-5 py-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {sellers.map((seller) => (
          <div
            key={seller._id}
            className="shadow-lg rounded-lg p-4 flex flex-col items-center bg-white border-2 border-[#0C821F]"
          >
            <img
            ...
            <button
              ...
              onClick={() => alert(`Contact Farmer: ${seller.farmName}`)}
            >
              Contact
            </button>
          </div>
